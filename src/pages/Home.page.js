                        ...
                        <div className='flex flex-col justify-between'>
                            <div>
                                <div className='w-full flex justify-between'>
                                    ...
                                    <button onClick={() => setMode()} aria-label="Toggle Dark Mode" type="button" class="h-fit w-fit p-2 bg-gray-200 rounded-lg dark:bg-[#444444] flex items-center justify-center hover:ring-2 ring-gray-300 transition-all">
