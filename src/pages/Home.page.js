                        ...
                        <div className='flex flex-col justify-between'>
                            <div>
                                <div className='w-full flex justify-between'>
                                    ...
                                    <button onClick={() => setMode()} aria-label="Toggle Dark Mode" type="button" class="w-9 h-9 bg-gray-200 rounded-lg dark:bg-gray-600 flex items-center justify-center hover:ring-2 ring-gray-300 transition-all">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-5 h-5 hidden dark:block">
