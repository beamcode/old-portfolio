...
export default function CvButton({ mobile }) {
    return (
        <button type="button" className={` ${mobile && 'min-w-[230px] md:hidden h-full'} py-1 px-3 pr-4 gap-2 flex items-center justify-between transition duration-100 hover:scale-[0.98] border border-[#9c1208] bg-[#C55300] shadow-md rounded-lg`}>
            {!mobile &&
