        ...
        <div className="w-full pt-4 px-5">
            ...
            <ol className="relative border-l border-gray-200 dark:border-[#363b3d]">
                ...
                <li className="mb-6 ml-4">
                    ...
                    <time className="block mb-2 text-md font-medium leading-none text-gray-600 dark:text-[#b1aaa0]">2019 - 2024</time>
                ...
                <li className="mb-6 ml-4">
                    ...
                    <time className="block mb-2 text-md font-medium leading-none text-gray-600 dark:text-[#b1aaa0]">2016 - 2019</time>
                    <div className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                        <ul>
