        ...
        <div className="w-full pt-4 px-5">
            <div className="flex items-center mb-3 gap-2 -ml-[19px]">
                <svg xmlns="http://www.w3.org/2000/svg" className="" width={40} preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                    <path fill="none" stroke="#50649c" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5.25 11.25L1.75 8l3.5-3.25m5.5 6.5L14.25 8l-3.5-3.25" />
                </svg>
                <h1 className="text-2xl font-semibold text-[#50649c]">Skills</h1>
            </div>

            <ol className="relative border-l border-gray-200">

                <li className="mb-6 ml-4">
                    <span className="flex absolute -left-[6.6px] justify-center items-center w-3 h-3 bg-blue-200 rounded-full" />
