        ...
        <div className="w-full pt-4 px-5">
            <div className="flex items-center mb-3 gap-2 -ml-[19px]">
                <svg xmlns="http://www.w3.org/2000/svg" className="" width={40} preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                    <path fill="none" stroke="#50649c" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M5.25 11.25L1.75 8l3.5-3.25m5.5 6.5L14.25 8l-3.5-3.25" />
                </svg>
            ...
            <ol className="relative border-l border-gray-200">
                ...
                <li className="mb-6 ml-4">
                    <span className="flex absolute -left-[6.6px] mt-[7.5px] justify-center items-center w-3 h-3 bg-blue-200 rounded-full" />
                ...
                <li className="mb-6 ml-4">
                    ...
                    <div className="flex items-center mb-1 gap-1">
                        ...
                        <h3 className="flex items-center text-lg font-semibold text-gray-900 mr-2">
                            C
                        </h3>
                ...
                <li className="mb-6 ml-4">
                    ...
                    <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Linux, bash scripting, GNU utils, nginx, nodejs. Good competence with unix-like systems and linux enviroments.</p>
                </li>
                ...
                <li className="mb-6 ml-4">
                    ...
                    <div className="flex items-center mb-1 gap-1">
                        ...
                        <h3 className="flex items-center text-lg font-semibold text-gray-900 whitespace-pre">
                            Fluent in
                        </h3>
